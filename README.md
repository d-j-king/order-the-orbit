...
An interactive explorer for the differential equation **dⁿx/dtⁿ = −kx** — what happens when you tie the nth derivative of position to (negative) displacement, for n = 1 through 5?
...
- n=1: velocity ∝ −x → exponential decay to anchor
- n=2: acceleration ∝ −x → simple harmonic motion, stable orbits
- n≥3: jerk/snap/crackle → some eigenvalues drift into Re > 0, orbits escape
